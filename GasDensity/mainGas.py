from functionGas import *

path = "C:/Users/adminRen/PycharmProjects/GasDensity"
fid_bk = os.path.join(path, 'gas2bk.bmp')
fid = os.path.join(path, 'gas2.bmp')
...
###############################
# Gas Introduce Fringe Shift ##
###############################
title2 = 'Phase Lines Shift from Gas'
